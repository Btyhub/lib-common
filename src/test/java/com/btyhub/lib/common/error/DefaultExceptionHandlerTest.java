...
import com.btyhub.lib.common.configuration.CommonProperties.ErrorsProperties;
import com.btyhub.lib.common.configuration.CommonProperties.ErrorsProperties.ErrorMessage;
import com.btyhub.lib.common.error.handler.DefaultExceptionHandler;
...
class DefaultExceptionHandlerTest {
    ...
    void handleExceptionTest(String code, String expectedCode, String expectedMessage,
        ...
        BtyhubException btyhubException = BtyhubException.of(code, args);

        ResponseEntity<HttpError> responseEntity = defaultExceptionHandler.handleException(btyhubException);
    ...
    void handleExceptionTest(String code, String expectedCode, String expectedMessage,
        ...
        BtyhubException btyhubException = BtyhubException.of(code);
    ...
    private CommonProperties retrieveCommonProperties() {
        ...
        ErrorsProperties errorProperties = new ErrorsProperties();
        Map<String, ErrorMessage> mapErrorMessages = new HashMap<String, ErrorMessage>();
